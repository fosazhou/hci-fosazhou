...
export const otherWorks: OtherWork[] = [
  ...
  },
  {
    ...
    processContent: {
      ...
      methodology: "项目采用人机协作的设计方法，将 AIGC 作为城市更新场景推演、空间意向生成与视觉表达的辅助工具。AI 负责快速生成多种空间氛围与风貌可能性，设计者负责筛选、判断、修正和整合，使生成结果服务于具体的城市空间问题。",
    ...
    researchContent: {
      ...
      approach: "项目建立了从场地特征提取到 AI 辅助表达的工作流程：首先梳理江夏城市更新中的空间问题与风貌关键词；随后构建不同主题的提示词，生成街区界面、公共活动、空间氛围和更新场景图像；再通过人工评估筛选具有空间逻辑和表达价值的结果；最终将 AI 图像转化为竞赛图面中的概念表达、场景渲染和设计叙事。",
      logic: [
